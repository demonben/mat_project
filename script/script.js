...
const fillerColors = document.querySelectorAll(
  ".constructor-filler-view__fillers"
);
const fillerColor = document.querySelector(".constructor-filler-view__fillers");
const fillerColorEva = document.querySelector(
  ".constructor-filler-view__fillers_eva"
);
...
const appData = {
  ...
  getFullPrice: () => {
    appData.fullPrice =
      appData.setPrice + appData.otherServices + appData.accessories;
  ...
  getImageNumber: () => {
    appData.imageNumber =
      appData.typeCarped +
      appData.skinColor +
      appData.typePatterns +
      appData.colorStr +
      appData.colorFiller +
      appData.colorEdgingFiller +
      appData.colorEdgingSkin;
  ...
  cleanFillerSkinColor: () => {
    document
      .querySelectorAll(".constructor-filler-view__skin")
      .forEach((item) => {
        item.classList.remove("active_flex");
      });
  },
  checkColorStr: () => {
    const colorsActive = document.querySelector(
      ".constructor-filler-view__skin.active_flex"
    );
  ...
  checkSkinColor: (select) => {
    select.addEventListener("change", (e) => {
      ...
      appData.skinColorName = `${e.target.options[
    ...
    if (getId.getAttribute("id") === "skin-color-selector-romb-1") {
      getId.addEventListener("change", (e) => {
        if (e.target.value === "1") {
          ...
          document
            .querySelector(".constructor-filler-view__skin_romb-1-black")
            .classList.add("active_flex");
        } else if (e.target.value === "2") {
          appData.cleanFillerSkinColor();
          document
            .querySelector(".constructor-filler-view__skin_romb-1-blue")
            .classList.add("active_flex");
        } else if (e.target.value === "3") {
          appData.cleanFillerSkinColor();
          document
            .querySelector(".constructor-filler-view__skin_romb-1-gold")
            .classList.add("active_flex");
        } else if (e.target.value === "4") {
          appData.cleanFillerSkinColor();
          document
            .querySelector(".constructor-filler-view__skin_romb-1-burgundy")
            .classList.add("active_flex");
        } else if (e.target.value === "5") {
          appData.cleanFillerSkinColor();
          document
            .querySelector(".constructor-filler-view__skin_romb-1-gray")
            .classList.add("active_flex");
        } else if (e.target.value === "6") {
          appData.cleanFillerSkinColor();
          document
            .querySelector(".constructor-filler-view__skin_romb-1-brown")
            .classList.add("active_flex");
        } else if (e.target.value === "7") {
          appData.cleanFillerSkinColor();
          document
            .querySelector(".constructor-filler-view__skin_romb-1-sand")
            .classList.add("active_flex");
        } else {
          appData.cleanFillerSkinColor();
        }
    ...
    if (getId.getAttribute("id") === "skin-color-selector-romb-2") {
      getId.addEventListener("change", (e) => {
        if (e.target.value === "1") {
          appData.cleanFillerSkinColor();
          document
            .querySelector(".constructor-filler-view__skin_romb-2-black")
            .classList.add("active_flex");
        } else if (e.target.value === "5") {
          appData.cleanFillerSkinColor();
          document
            .querySelector(".constructor-filler-view__skin_romb-2-gray")
            .classList.add("active_flex");
        } else if (e.target.value === "6") {
          appData.cleanFillerSkinColor();
          document
            .querySelector(".constructor-filler-view__skin_romb-2-brown")
            .classList.add("active_flex");
        } else if (e.target.value === "7") {
          appData.cleanFillerSkinColor();
          document
    ...
    if (getId.getAttribute("id") === "skin-color-selector-romb-3") {
      getId.addEventListener("change", (e) => {
        if (e.target.value === "1") {
          appData.cleanFillerSkinColor();
          document
            .querySelector(".constructor-filler-view__skin_romb-3-black")
            .classList.add("active_flex");
        } else if (e.target.value === "2") {
          appData.cleanFillerSkinColor();
          document
            .querySelector(".constructor-filler-view__skin_romb-3-blue")
            .classList.add("active_flex");
        } else if (e.target.value === "7") {
          appData.cleanFillerSkinColor();
          document
    ...
    if (getId.getAttribute("id") === "skin-color-selector-square") {
      getId.addEventListener("change", (e) => {
        if (e.target.value === "1") {
          appData.cleanFillerSkinColor();
          document
            .querySelector(".constructor-filler-view__skin_square-black")
            .classList.add("active_flex");
        } else {
          appData.cleanFillerSkinColor();
        }
    ...
    fillerChoice.onclick = (e) => {
      if (e.target.closest("input")) {
        if (e.target.checked) {
          ...
          document.querySelectorAll(".display_none").forEach((item) => {
    ...
    patterns.onclick = (e) => {
      if (e.target.closest("input")) {
        if (e.target.checked) {
          ...
          document
            .querySelectorAll('select[name="skin-color-selector"]')
            .forEach((item) => {
              item.classList.remove("active");
              item.value = "Цвета";
            });
          const getId = document.getElementById(
            `${e.target.getAttribute("data-pattern")}`
          );
...
const accordion = () => {
  ...
  accordionItem.addEventListener("click", (e) => {
    if (
      ...
      e.target
        .closest("li")
        .querySelector(".accordion-item__ask").style.display = "block";
      e.target
        .closest("li")
        .querySelector(
      ...
      e.target
        .closest("li")
        .querySelector(".accordion-item__ask").style.display = "";
      e.target
        .closest("li")
        .querySelector(
          ".accordion-item__plus > span:last-of-type"
